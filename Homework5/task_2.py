...
def repeats(our_str):
    """
    смотрит, сколько раз каждый символ уже встречался, записывая на выходе формат e_1 соединяя буквы в строке в единую
    строку
    :param our_str:  строка со словом
